...
//        }
        ...
        if(wsmodel.getIsmerchanttransaction() != null) {
            logger.info("IsMerchantTxn [" + wsmodel.getIsmerchanttransaction() + "]");
        }
        if(wsmodel.getMerchantschemeid() != null) {
            logger.info("MerchantSchemeId [" + wsmodel.getMerchantschemeid() + "]");
        }
