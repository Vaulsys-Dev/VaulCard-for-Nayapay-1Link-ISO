...
//    private String nayapayid;
    ...
    //Raza Adding for OneLink Biller in-case if it is required, currently for logging only
...
//    }
    ...
    // =====================================================================================
    //Arsalan Akhter, Date: 07-Oct-2021, Ticket: VP-NAP-202110051 / VC-NAP-202110053(Document 4.9.1 - Notifications Update)
    public String getDeclinedbycardctrl() {
        return declinedbycardctrl;
    }

    public void setDeclinedbycardctrl(String declinedbycardctrl) {
        this.declinedbycardctrl = declinedbycardctrl;
    }
    //=====================================================================================================================
    ...
    public void setIsmerchanttransaction(Boolean merchantTransaction) {
        ismerchanttransaction = merchantTransaction;
    }
    ...
    public String getMerchantschemeid() {
        return merchantschemeid;
    }

    public void setMerchantschemeid(String merchantschemeid) {
        this.merchantschemeid = merchantschemeid;
    }
