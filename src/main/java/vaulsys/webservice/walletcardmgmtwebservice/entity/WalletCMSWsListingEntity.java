...
//    }
    ...
    public WalletCMSWsListingEntity copy(WalletCMSWsEntity cmsWsEntity) {
        ...
        this.setIsmerchanttransaction(cmsWsEntity.getIsmerchanttransaction());
        this.setCardid(cmsWsEntity.getCardid());
        this.setMerchantschemeid(cmsWsEntity.getMerchantschemeid());
