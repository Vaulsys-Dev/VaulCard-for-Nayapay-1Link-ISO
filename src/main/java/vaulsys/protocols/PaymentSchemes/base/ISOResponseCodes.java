...
public class ISOResponseCodes {
    ...
    public static final String CUSTOMER_INACTIVE = "03";//Huzaifa Added 09/03/2024 - VC-NAP-202408093 == Rejections with Invalid Codes - RC32
    ...
    public static final String ACCT_DEBIT_FREEZE = "162"; // Asim Shahzad, Date : 12th Oct 2023, Tracking ID : VC-NAP-202303062
