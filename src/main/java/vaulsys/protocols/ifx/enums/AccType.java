...
public class AccType implements Cloneable, Serializable {
	...
	*/
	...
	// Added By Waleed, Date 27 Sep 2024
	public static final String CAT_ARC_SUSPENSE_ACCT_VALUE = "ARC_SUSPENSE_ACCT";
	public static final String CAT_ARC_SUSPENSE_WLLT_VALUE = "ARC_SUSPENSE_WLLT";

	public static final AccType CAT_ARC_SUSPENSE_WLLT =  new AccType(CAT_ARC_SUSPENSE_WLLT_VALUE);
	public static final AccType CAT_ARC_SUSPENSE_ACCT =  new AccType(CAT_ARC_SUSPENSE_ACCT_VALUE);
	// ===================================================================================
	...
	// Asim Shahzad, Date : 12th Oct 2023, Tracking ID : VC-NAP-202303062
	public static final String CAT_MERCH_REV_WALLET_VALUE = "MER_REV_WLLT";
	public static final String CAT_MERCH_EXP_WALLET_VALUE = "MER_EXP_WLLT";
	private static final String CAT_ARC_1LINK_VISA_SETT_PAYABLE_ACCT_VALUE = "ARC_1LINK_VISA_SETT_PAYABLE_ACCT";
	private static final String CAT_ARC_1LINK_VISA_SETT_PAYABLE_WLLT_VALUE = "ARC_1LINK_VISA_SETT_PAYABLE_WLLT";
	...
	public static final String CAT_ARC_1LINK_SETT_RECEIVABLE_ACCT_VALUE = "ARC_1LINK_SETT_ACCT_REC";
	public static final String CAT_ARC_1LINK_SETT_RECEIVABLE_WLLT_VALUE = "ARC_1LINK_SETT_WLLT_RECEIVABLE";
	public static final String CAT_ARC_1LINK_SETT_PAYABLE_ACCT_VALUE = "ARC_1LINK_SETT_ACCT_PAYABLE";
	public static final String CAT_ARC_1LINK_SETT_PAYABLE_WLLT_VALUE = "ARC_1LINK_SETT_WLLT_PAYABLE";
	...
	// Asim Shahzad, Date : 12th Oct 2023, Tracking ID : VC-NAP-202303062
	public static final AccType CAT_MERCH_REV_WALLET =  new AccType(CAT_MERCH_REV_WALLET_VALUE);
	public static final AccType CAT_MERCH_EXP_WALLET =  new AccType(CAT_MERCH_EXP_WALLET_VALUE);
	//====================================================================
	...
	// Asim Shahzad, Date : 16 Nov 2023, Tracking ID : VC-NAP-202303062
	public static final AccType CAT_ARC_1LINK_VISA_SETT_PAYABLE_ACCT =  new AccType(CAT_ARC_1LINK_VISA_SETT_PAYABLE_ACCT_VALUE);
	public static final AccType CAT_ARC_1LINK_VISA_SETT_PAYABLE_WLLT =  new AccType(CAT_ARC_1LINK_VISA_SETT_PAYABLE_WLLT_VALUE);
	...
	public static final AccType CAT_ARC_1LINK_SETT_RECEIVABLE_ACCT =  new AccType(CAT_ARC_1LINK_SETT_RECEIVABLE_ACCT_VALUE);
	public static final AccType CAT_ARC_1LINK_SETT_RECEIVABLE_WLLT =  new AccType(CAT_ARC_1LINK_SETT_RECEIVABLE_WLLT_VALUE);
	public static final AccType CAT_ARC_1LINK_SETT_PAYABLE_ACCT =  new AccType(CAT_ARC_1LINK_SETT_PAYABLE_ACCT_VALUE);
	public static final AccType CAT_ARC_1LINK_SETT_PAYABLE_WLLT =  new AccType(CAT_ARC_1LINK_SETT_PAYABLE_WLLT_VALUE);
